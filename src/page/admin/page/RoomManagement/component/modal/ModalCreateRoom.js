...
export const ModalCreateRoom = (props) => {
    // Props
    const { title, isOpen, childrenForm, methodCancel, fetcher,
        fetch } = props;
    ...
    const {
        ...
        defaultValues: {
            tenSach: "",
            hinhAnh: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDF9695aEHL20tZNMzJ26nIGr5AYMKr_eaoxXWtDkngU8M8KXhqPQXkhyamMWJ1mvbeYU&usqp=CAU",
        },
    });
